...
{
  "gitBranch" : "main",
  "gitUrl" : "https://gitea.tap.amer.end2end.link/gitea_admin/tap-demos-w01-s1016-1649333792.git",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/tanzu-end-to-end/spring-sensors.git->https://gitea.tap.am...(truncated), main->main]
